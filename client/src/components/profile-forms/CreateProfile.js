    ...
    return(
        <Fragment>
            ...
            <form className="form" onSubmit={e => onSubmit(e)}>
                ...
                <div className="form-group">
                    <input type="text" placeholder="Company" name="company" value={mobileNo} onChange={e=>onChange(e)}/>
                    <small className="form-text"
                    >Could be your own company or one you work for</small
                    >
                </div>
                <div className="form-group">
                    <input type="text" placeholder="Website" name="website" value={gender} onChange={e=>onChange(e)}/>
                    <small className="form-text"
                    >Could be your own or a company website</small
                    >
                </div>
                {/*<div className="form-group">*/}
                {/*    <input type="text" placeholder="Location" name="location" value={role} onChange={e=>onChange(e)}/>*/}
                {/*    <small className="form-text"*/}
